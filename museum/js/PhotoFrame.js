...
//        const geometry = new THREE.PlaneGeometry( height, width);
        ...
        var wood_material = new THREE.MeshBasicMaterial( {map: loader.load('assets/floor-texture.jpeg'), side: THREE.DoubleSide} );
        
        var frame_width = 1;
        
        this.top_frame = new THREE.Mesh(
                new THREE.BoxGeometry( width + 2*frame_width, frame_width, 1),
                wood_material);
        ...
        this.left_frame = new THREE.Mesh(
                new THREE.BoxGeometry( height + 2*frame_width, frame_width, 1),
                wood_material);
